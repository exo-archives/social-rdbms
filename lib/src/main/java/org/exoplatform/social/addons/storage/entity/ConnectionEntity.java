...
@NamedQueries({
        ...
        @NamedQuery(name = "SocConnection.getConnections",
                query = "SELECT connection.sender.id as sender, connection.receiver.id  as receiver from SocConnection connection where (connection.sender.id = :identityId or connection.receiver.id = :identityId) AND connection.status = :connStatus"),
